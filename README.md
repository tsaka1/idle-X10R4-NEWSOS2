...
あり、暗くした画面上を Macintosh のアイコンがひょこひょこと表示されました。
それと同様の動きをするので、idle と名付けています。
...
2026年3月7日追記。
2025年にこのidleをNetNewsのfj.sourcesに投稿した記事のアーカイブが見つかったので、
リンクしておきます。投稿したのは1988年11月22日ですね。
https://katsu.watanabe.name/ancientfj/article.php?mid=1388%40ulisvax.ulis.JUNET
